...
| 2026-08-18 17:48 to 17:54 | money | Leak clips spread and the `$CYBERLEEK` launch is front-run: four wallets buy in a ~6-minute window, none tracing to the deployer; on a full pull these are automated sniper bots, not tipped insiders (Divyasshree N / Bitquery, confirmed on our pull) | on-chain, [`operation/crosscheck/`](real/crypto/evidence/operation/crosscheck/) |
