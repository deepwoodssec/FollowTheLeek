...
| --- | --- | --- |
| `real/crypto/evidence/` package (SHA256SUMS.txt) | `d986442e2b4247682d76e3c67038e77b9cb5952bb2223ef7affe14d5e926d78f` | 2026-08-30 |
...
| Cross-check + cash-out on-chain pulls (snipers, poisoning, deployer/funder proof, and the 2026-08-27 fee-claim / swap / split-to-exchanges trace) | `real/crypto/evidence/operation/crosscheck/` | see `SHA256SUMS.txt` (manifest `d986442e`) | 2026-08-30 |
