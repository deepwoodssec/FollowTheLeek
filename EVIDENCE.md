...
| --- | --- | --- |
| `real/crypto/evidence/` package (SHA256SUMS.txt) | `cc6aeaf608c51ecf798998dcc72c50c8f5372cc63442d5536ba16aee18af2824` | 2026-08-30 |
...
| Cross-check + cash-out on-chain pulls (snipers, poisoning, deployer/funder proof, and the 2026-08-27 fee-claim / swap / split-to-exchanges trace) | `real/crypto/evidence/operation/crosscheck/` | see `SHA256SUMS.txt` (manifest `cc6aeaf6`) | 2026-08-30 |
